...
tensorflow/contrib/makefile/compile_ios_protobuf_64.sh

# Build the iOS TensorFlow libraries.
tensorflow/contrib/makefile/compile_ios_tensorflow_64.sh "-O3"

# Creates a static library for 64bit iOS in
